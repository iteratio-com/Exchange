...
inventory_displayhints.update(
    {
        ...
        ".software.applications.sapmaxdb.globalsapdbprograms:*.name": {
            "title": _("Package Name")
        },
        ".software.applications.sapmaxdb.globalsapdbprograms:*.binary": {
            "title": _("Binary Format")
        },
        ".software.applications.sapmaxdb.cl_sapdbclients:*.name": {
            "title": _("Package Name")
        },
        ".software.applications.sapmaxdb.cl_sapdbclients:*.binary": {
            "title": _("Binary Format")
        },
        ".software.applications.sapmaxdb.sapdbdb:*.name": {"title": _("Package Name")},
        ".software.applications.sapmaxdb.sapdbdb:*.binary": {
            "title": _("Binary Format")
        },
    }
)
