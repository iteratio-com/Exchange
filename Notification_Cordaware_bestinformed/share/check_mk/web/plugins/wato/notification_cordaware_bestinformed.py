            ...
            elements=[
                (
                    ...
                    TextInput(
                        ...
                        help=_(
                            "Use this for specify the Cordaware bestinformed Host with Port, e.g. <tt>https://monitor:8431</tt>"
                        ),
                        regex="^(http|https)://.*",
                ...
                (
                    ...
                    TextInput(
                        ...
                        help=_(
                            "Fill here the Hostname of the Monitoring Hosts, e.g. Checkmk.Foo.Bar."
                ...
                (
                    "api_ssl_verify",
                    DropdownChoice(
                        title=_("Check HTTPS Certificate"),
                        choices=[("true", _("Enable Checking")), ("false", _("Disable checking"))],
                        default_value="false",
                    ),
                ),
                (
                ...
                (
                    "active",
                    Integer(
                        title=_("Active Time of message"),
                ...
                (
                    ...
                    TextUnicode(
                        title=_("INFO Background Caption"),
                        help=_("Fill here the Color as Hex Code"),
